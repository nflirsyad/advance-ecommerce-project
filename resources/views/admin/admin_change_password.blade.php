                        ...
                        <form method="POST" action="{{route('update.change.password')}}">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="password" name="password_confirmation" id="password_confimation" class="form-control" required="" data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                ...
                                <div class="text-xs-right">
                                    <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Change">
                                </div>
                        </form>
                    </div>
                </div>
